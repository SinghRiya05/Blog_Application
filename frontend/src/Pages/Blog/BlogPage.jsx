  ...
  return data ? (
    <div className="mt-2 relative">
      <div className="text-center mt-10 leading-[2.5rem]">
        <p className="text-[#352f44] text-lg fo">
      ...
      <div className="mx-5 max-w-5xl md:mx-auto my-10 mt-6 ">
        <div className="flex justify-center">
          <img src={data.image} alt="" className="rounded-3xl mb-5 w-[30rem]" />
        </div>
        <div
          ...
          <div className="flex flex-col gap-4">
            {comments.map((item, index) => (
              ...
              >
                ...
                <div className=" absolute right-4 bottom-2 flex items-center gap-2 text-[14px]   text-gray-700">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            <input
              ...
              required
              className="w-full p-2 border border-gray-300 rounded outline-none font-meduim text-base"
            />
            <textarea
              placeholder="Comment"
              value={content}
              onChange={(e) => setContent(e.target.value)}
              className="w-full p-2 border border-gray-300 rounded outline-none h-48 font-medium text-base"
            ></textarea>
            <button
              type="Submit"
