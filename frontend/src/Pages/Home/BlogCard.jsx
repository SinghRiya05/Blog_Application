...
const naviagte=useNavigate();
  return (
     ...
     <div onClick={()=>{naviagte(`blog/${_id}`)}} className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl hover:scale-[1.02] transition-transform duration-300 cursor-pointer w-80">
